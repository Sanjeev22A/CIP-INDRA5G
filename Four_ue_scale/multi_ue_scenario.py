...
class multi_ue_scenario(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.ue4_path_loss_db = ue4_path_loss_db = 30
        ...
        # Blocks
        ##################################################
        self._ue4_path_loss_db_range = Range(0, 100, 1, 30, 200)
        ...
        self.zeromq_req_source_0_0_0 = zeromq.req_source(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:2401', zmq_timeout, False, zmq_hwm)
        ...
        self.zeromq_rep_sink_0_2_0 = zeromq.rep_sink(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:2400', 100, False, zmq_hwm)
        ...
        self.blocks_multiply_const_vxx_0_1_0_0_0 = blocks.multiply_const_cc(10**(-1.0*ue4_path_loss_db/20.0))
        self.blocks_multiply_const_vxx_0_1_0_0 = blocks.multiply_const_cc(10**(-1.0*ue4_path_loss_db/20.0))
        ...
        self.connect((self.blocks_multiply_const_vxx_0_1_0_0, 0), (self.zeromq_rep_sink_0_2_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0_1_0_0_0, 0), (self.blocks_add_xx_0, 3))
        ...
        self.connect((self.zeromq_req_source_0_0_0, 0), (self.blocks_multiply_const_vxx_0_1_0_0_0, 0))
    ...
    def set_ue4_path_loss_db(self, ue4_path_loss_db):
        ...
        self.blocks_multiply_const_vxx_0_1_0_0.set_k(10**(-1.0*self.ue4_path_loss_db/20.0))
        self.blocks_multiply_const_vxx_0_1_0_0_0.set_k(10**(-1.0*self.ue4_path_loss_db/20.0))
